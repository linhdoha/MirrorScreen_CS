...
namespace KinectCam
{
    ...
    [ComVisible(true)]
    [Guid("074E85A1-1FDD-409C-8130-B3A5DF5701E8")]
    ...
    public class VirtualCamFilter : BaseSourceFilter, IAMFilterMiscFlags
    {
        ...
        private const int c_iDefaultWidth = 512;
        private const int c_iDefaultHeight = 424;
        ...
        private const int c_nMinWidth = 512;
        private const int c_nMinHeight = 424;
        ...
        public VirtualCamFilter()
            : base("Kinect Camera V2 Body Index")
        {
        ...
        public unsafe int FillBuffer(ref IMediaSampleImpl _sample)
        {
            ...
            if (!KinectCamSettings.Default.Desktop)
            {
                //KinectHelper.GenerateFrame(_ptr, length, KinectCamSettigns.Default.Mirrored);
                KinectHelper.GenerateBodyIndexFrame(_ptr, length, KinectCamSettings.Default.Mirrored);
            }
            else
            {
                if (m_hBitmap == IntPtr.Zero)
